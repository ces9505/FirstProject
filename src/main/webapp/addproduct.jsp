...
<body>
	...
	<div class="container">
		<h1 class="text-center p-5">물품등록</h1>
		<form action="insertBoard.do" method="post"
			...
			<div class="form-group">
				<input type="number" class="form-control" placeholder="가격입력"
					id="price" name="price">
			</div>

			<div class="filebox mt-3">
				<input class="upload-name" placeholder="소개이미지"> <label
					class="bg-secondary text-light rounded mt-1" for="file">파일찾기</label>
			...
			<div class="form-group">
				<label for="place">거래지역:</label> <input type="text"
					class="form-control" value="전국" id="place" name="place" readonly>
			...
			<div class="form-group">
				<textarea class="form-control" id="content" name="content"  rows="10" placeholder="게시글 내용입력"></textarea>
